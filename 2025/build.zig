...
pub fn build(b: *std.Build) void {
    ...
    // Create executables for each day (day1, day2, etc.) that exists
    for (1..26) |day_num| {
        const day = b.fmt("day{d}", .{day_num});
        const source_path = b.fmt("src/{s}.zig", .{day});
    ...
    // Test step for the shared module
